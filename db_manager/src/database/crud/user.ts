...
export async function createAdminUser(firstName: string, lastName: string, email: string, password: string): Promise<User> {
    const [result] = await pool.execute<ResultSetHeader>(
...
export async function updateUser(id: number, firstName: string, lastName: string, email: string, password: string | null): Promise<User> {
